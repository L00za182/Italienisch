...
export function runLesson(ctx, lesson) {
  ...
  function renderChoice(step) {
    ...
    step.options.forEach(o => {
      ...
      b.addEventListener('click', () => {
        ...
        // Nach der Antwort immer das Italienische hören – bei Übungen mit
        // deutschem Prompt steht es in answerSpeak.
        const say = step.answerSpeak || step.speak;
  ...
  function renderType(step) {
    ...
    const stage = h('div', { class: 'stage' },
      h('div', { class: 'q-label' }, step.question.toUpperCase()),
      h('div', { class: 'prompt-card' },
        step.image ? h('div', { class: 'pic' }, pic(step.image)) : null,
  ...
  function renderGrammar(step) {
    ...
    return h('div', { class: 'stage' },
      ...
      h('div', { class: 'card', style: 'text-align:center;padding-bottom:6px' },
        h('div', { style: 'font-size:40px' }, pic(g.icon)),
  ...
  function renderDialogue(step) {
    ...
    return h('div', { class: 'stage' },
      ...
      h('div', { class: 'card', style: 'text-align:center' },
        h('div', { style: 'font-size:40px' }, pic(d.icon)),
  ...
  function renderDone() {
    ...
    if (milestone) {
      box.append(h('div', { class: 'cert', style: 'margin-bottom:14px' },
        h('div', { class: 'seal' }, pic(milestone.icon)),
